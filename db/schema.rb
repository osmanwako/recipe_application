...
ActiveRecord::Schema[7.0].define(version: 20_230_807_201_819) do
  ...
  create_table 'recipes', force: :cascade do |t|
    ...
    t.string 'preparation_time', default: '1hr', null: false
    t.string 'cooking_time', default: '1hr', null: false
